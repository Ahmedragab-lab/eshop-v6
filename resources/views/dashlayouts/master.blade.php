...
<html lang="en">
	<head>
		@include('dashlayouts.dashcss')
	</head>
	<body class="main-body app sidebar-mini dark-theme">
		<!-- Loader -->
		<div id="global-loader">
			<img src="{{ asset('dashassets/img/loader.svg') }}" class="loader-img" alt="Loader">
		</div>
		<!-- /Loader -->
                ...
                <div class="container-fluid">
                    <div class="main-header-left ">
                        <div class="responsive-logo">
                            <a href="index.html"><img src="{{ asset('dashassets/img/brand/logo.png') }}" class="logo-1" alt="logo"></a>
                            <a href="index.html"><img src="{{ asset('dashassets/img/brand/logo-white.png') }}" class="dark-logo-1" alt="logo"></a>
                            <a href="index.html"><img src="{{ asset('dashassets/img/brand/favicon.png') }}" class="logo-2" alt="logo"></a>
                            <a href="index.html"><img src="{{ asset('dashassets/img/brand/favicon.png') }}" class="dark-logo-2" alt="logo"></a>
                        </div>
